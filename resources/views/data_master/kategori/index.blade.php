            ...
            <div class="row layout-top-spacing">
                ...
                <div class="col-xl-4 col-lg-4 col-sm-4  layout-spacing">
                    <div class="widget-content widget-content-area br-8">
                        <div class="card">
                            <div class="card-body">
                                <form class="row g-3" id="form-kategori">
                                    @csrf
                                    <input type="hidden" name="id" id="id">
                                    <div class="col-12">
                                        <label for="Nama kategori" class="form-label">Nama kategori</label>
                                        <input type="text" name="nama_kategori" id="nama_kategori" class="form-control input" placeholder="Masukan nama kategori">
                                    </div>
                                    <div class="col-12">
                ...
                <div class="col-xl-8 col-lg-8 col-sm-8  layout-spacing">
                    <div class="widget-content widget-content-area br-8">
                        <table id="data-kategori" class="table dt-table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    <th width="10%">No</th>
